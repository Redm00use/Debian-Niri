...
PanelWindow {
  ...
  BackgroundEffect.blurRegion: Region {
    ...
    Region {
      ...
      topLeftRadius: backgroundBlur.panelBg ? backgroundBlur.panelBg.topLeftCornerState : 0
      topRightRadius: backgroundBlur.panelBg ? backgroundBlur.panelBg.topRightCornerState : 0
      bottomLeftRadius: backgroundBlur.panelBg ? backgroundBlur.panelBg.bottomLeftCornerState : 0
      bottomRightRadius: backgroundBlur.panelBg ? backgroundBlur.panelBg.bottomRightCornerState : 0
    }
    ...
    Region {
      ...
      radius: Style.radiusL
      topLeftRadius: backgroundBlur.closingPanelBg ? backgroundBlur.closingPanelBg.topLeftCornerState : 0
      topRightRadius: backgroundBlur.closingPanelBg ? backgroundBlur.closingPanelBg.topRightCornerState : 0
      bottomLeftRadius: backgroundBlur.closingPanelBg ? backgroundBlur.closingPanelBg.bottomLeftCornerState : 0
      bottomRightRadius: backgroundBlur.closingPanelBg ? backgroundBlur.closingPanelBg.bottomRightCornerState : 0
    }
  }
